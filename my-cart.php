...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="/css/rahul.css">
...
<?php
// Include your existing database connection code
include('config.php');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $sql = "INSERT INTO shopping (deliver) VALUES ('$selectedOption')";
...
<div class="custom-select">
    <label for="options">You Want to Recieve Your Products in Every:</label>
    <select id="options" onchange="showInputField()">
        <option value="1">Week</option>
        <option value="2">Fortnightly</option>
        <option value="3">Monthly</option>
        <option value="4">Custom Delivery Schedule</option>
    </select>
...
<br> 
						...
						<button type="submit" name="ordersubmit" class="btn btn-primary">Subscribe</button>
